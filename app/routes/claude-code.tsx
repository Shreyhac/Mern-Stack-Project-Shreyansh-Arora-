                ...
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-8">
                  ...
                  <div className="grid gap-6 md:grid-cols-3">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-zinc-400">Click the "Add to Chrome" button to install from Chrome Web Store</p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-zinc-400">Install the extension from Chrome Web Store</p>
                    </div>
