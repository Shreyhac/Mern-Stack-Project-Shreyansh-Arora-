    ...
    <Container className="py-16 md:py-24">
      ...
      <Accordion type="single" collapsible className="w-full max-w-4xl mx-auto">
        ...
        <AccordionItem value="item-6">
          ...
          <AccordionContent>
            <div className="space-y-3 text-zinc-400">
              <p>Yes! Web to MCP is completely free to use. We believe in making powerful development tools accessible to everyone.</p>
              <p>You get unlimited component captures, full access to all features, and no hidden costs. Our goal is to enhance your development workflow without any barriers.</p>
            </div>
          </AccordionContent>
        </AccordionItem>
