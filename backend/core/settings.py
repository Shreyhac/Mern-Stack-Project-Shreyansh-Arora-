...
# Database
DATABASE_URL = config(
    "DATABASE_URL", default="mysql://root:password@localhost:3306/django_oauth_db"
)
...
# Payment Configuration (Removed for demo purposes)
# All payment-related features have been removed for college submission
